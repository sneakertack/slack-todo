// This file is suchly named because the original intention was to make this handle all sorts of slash-related extra functionality, not just/todo.
    ...
    default:
      if (slashObject.todoData.trim().length > 0) {
        ...
        deferred.resolve(todoList(slashObject).then(function (ls) {
          return ls+' Type \'/todo help\' to see commands.\n';
        }));
      }
  }
...
function todoList(s) {
  ...
  return dbUp.then(function (db) {
    ...
    response.append('Type \'/todo x <number>\' to clear a task.');
